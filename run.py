...
def like_stories(username, password, usernames):
    ...
    for follower in usernames:
        ...
        view_story_xpath1 = "/html/body/div[2]/div/div/div[2]/div/div/div[1]/div[1]/section/div[1]/div/section/div/div[1]/div/div/div/div/div[3]/div"
        like_button_xpath = "//div/div/div[2]/div/div/div[1]/div[1]/section/div[1]/div/div/div[1]/div[2]/div[2]/div[1]/div[2]/span/div"
        like_button_xpath1 = "/html/body/div[2]/div/div/div[2]/div/div/div[1]/div[1]/section/div[1]/div/section/div/div[3]/div/div/div[2]/span/div/div"
        ...
        try:
            ...
            try:
                # Try the second path if the first one fails
                view_story_button = driver.find_element(
                    By.XPATH, view_story_xpath1)
                print("[TRUE] User -> " + follower + " has a story up.")
                view_story_button.click()
                time.sleep(4)
...
if __name__ == "__main__":
    ...
    followers_file = "nthn_followerss.txt"
